...
import com.ighe3.api.service.payman.ReportService;
...
public class ReportServiceImpl implements ReportService {
    ...
    public ReportServiceImpl(HttpService httpService, Urls urls, AccessTokenServiceImpl accessTokenService) {
    ...
    public PaymanReportResponse getReport(String paymanId) throws BaseException {
        ...
        Response paymanResponse = httpService.sendRequest(request, ReportServiceImpl.class);
