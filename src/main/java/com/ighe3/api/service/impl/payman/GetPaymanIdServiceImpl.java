...
@Service
public class GetPaymanIdServiceImpl implements GetPaymanIdService {

    private final HttpService httpService;
    private final Urls urls;
    private final AccessTokenServiceImpl accessTokenService;

    public GetPaymanIdServiceImpl(HttpService httpService, Urls urls, AccessTokenServiceImpl accessTokenService) {
    ...
    public String getPaymanId(String paymanCode) throws BaseException {
        ...
        Response paymanResponse = httpService.sendRequest(request, GetPaymanIdServiceImpl.class);
